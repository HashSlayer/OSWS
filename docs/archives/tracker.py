...
class TrackerGUI:
    ...
    def create_text_boxes(self):
        ...
        welcome_text = """
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      Welcome to Click Tracker
    ❤️ Press the [left CTRL] key to toggle tracking ON/OFF
...
"""
    ...
    def toggle_bot(self):
        ...
        if self.running:
            self.append_message("Tracking started")
            ...
            self.append_message("Tracking stopped")
    ...
    def kill_bot(self):
        ...
        self.append_message("Tracking terminated")
